...
function assertInventoryCoverage(manifest) {
  ...
  const nonIntegrationDirectories = new Set([
    '.github', 'assets', 'deliverables', 'dist', 'docs', 'examples', 'sdk', 'skills', 'specs', 'src', 'templates', 'test',
  ]);
...
function assertDiscoveryParity(manifest) {
  ...
  if (!nestedSkill.includes('https://agoragentic.com/skill.md') || !nestedSkill.includes('https://github.com/rhein1/agoragentic-integrations')) {
