...
test('runner accepts only the closed bounded operation and writes one exact atomic result', async (t) => {
  ...
  const job = {
    ...
    parent_state_hash: sha256Ref('parent-state'),
    capsule_hash: sha256Ref('capsule'),
    identity_hash: sha256Ref('identity'),
    provider_ref: 'provider:e2b-test',
    template_id_hash: sha256Ref('template'),
    mcp_phase: 'tools/call',
    mcp_server_ref: 'server:e2b-test',
    tool_name: 'synthetic_test',
    effective_arguments_hash: sha256Ref('arguments'),
