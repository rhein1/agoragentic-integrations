...
| Optimized Python qualification | `qualification-safety.test.mjs` | Qualification, fixture-evidence, and adapter-entrypoint checks contain no removable assertions; paid gating and deliberate failures remain stable under normal Python and `python -O` |
