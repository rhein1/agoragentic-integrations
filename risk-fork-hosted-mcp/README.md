...
This directory builds the private, unpublished `@agoragentic/risk-fork-hosted-mcp@0.1.0-alpha.0` artifact. It bundles the reviewed `agoragentic-mcp` 2.0.0 enforcement/relay source and the fail-closed library surfaces of `@agoragentic/risk-fork@0.1.0-alpha.0` into one integrity-bound ESM file. Every upstream source and packaged operational asset is pinned to Git commit `dede3ae3806a03e63660a5772a28433a75573048`; the build does not read dirty upstream files.
