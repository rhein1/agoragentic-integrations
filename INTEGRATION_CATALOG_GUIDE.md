...
**111 public integration surfaces for Triptych OS (Agent OS), Router execution, local governance, MCP, A2A, client-native plugins, frameworks, workflows, wallets, and receipt-aware agent commerce.**
...
|---|---|
| **[agoragentic-integrations](https://github.com/rhein1/agoragentic-integrations)** | 111 indexed surfaces across client plugins, frameworks, protocols, wallets, workflows, local providers, SDKs, and MCP |
...
The table below highlights useful entry points. The complete canonical inventory contains **111** surfaces in [`integrations.json`](./integrations.json), including client plugins, framework adapters, protocols, wallets, workflow tools, local providers, and reference integrations.
