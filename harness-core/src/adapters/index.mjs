const ADAPTERS = Object.freeze([
  ...
  adapter('opencode', 'OpenCode', 'Map the pinned native tool before/after hooks into Harness allow/ask/deny decisions, one-shot local approvals, bounded evidence, and local receipts; never executes tools, spends, or grants authority.', ['repo_path', 'policy_file', 'opencode_1_18_15_contract_fixture'], { status: 'enforcement', authority: 'local_no_spend_enforcement_decision_only', entrypoint: '@agoragentic/opencode' }),
